...
- name: Akamai API Remove a Customer
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/custom/master/_listings/akamai/config-saas-registration-v1-customers-surrogateid-delete.md
x-common:
- type: x-base
