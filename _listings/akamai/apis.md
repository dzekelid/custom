...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/custom/master/_listings/akamai/events-v2-accountid-events-startrange,endrange,sortfield,sortorder,startindex,limit,customereventid-post.md
x-common:
- type: x-base
