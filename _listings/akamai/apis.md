...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/custom/master/_listings/akamai/galaxy-v1-customers-akamaicustomerid-op-reactivate-post.md
x-common:
- type: x-base
