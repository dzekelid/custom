...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/custom/master/_listings/akamai/events-v2-accountid-events-id-startrange,endrange,sortfield,sortorder,startindex,limit,customereventid-get.md
x-common:
- type: x-base
